...
<head>
    ...
    <title>Successfully Registered | NSBM CAFETERIA</title>
</head>
...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
            <img src="img/cafeteria-logo.png" width="125" height="50" class="me-2" alt="NSBM CAFETERIA Logo">
    ...
    <div class="container form-signin text-center reg-success mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold">Welcome and enjoy your food with FOODCAVE</p>
